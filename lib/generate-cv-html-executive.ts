    ...
    for (const [fieldKey, value] of Object.entries(safePersonalInfo.optionalFields)) {
      ...
      if (value && String(value).trim() !== '') {
        ...
        if (isCustomField) {
          ...
          contactItems.push(`<span class="cv-contact-item-executive">${customIcon}${customPrefix}${value}</span>`)
        } else {
  ...
  sectionOrder.forEach(sectionId => {
    ...
    switch (sectionId) {
      ...
      case 'awards':
        ...
        html += `<div class="cv-section-executive">`
        html += `<h2 class="cv-section-title-executive">${sectionToUse.title || 'UTMÄRKELSER'}</h2>`
        html += `<div class="cv-section-content-executive">`
        data.sections.awards.forEach((award: any) => {
          ...
          html += `<div class="cv-item-executive" data-keep>`
          html += `<div class="cv-item-header-executive">`
          if (awardTitle) html += `<h3 class="cv-item-title-executive">${awardTitle}</h3>`
          if (awardDate) html += `<span class="cv-item-date-executive">${awardDate}</span>`
          html += `</div>`
          if (awardIssuer) html += `<p class="cv-item-subtitle-executive">${awardIssuer}</p>`
      ...
      case 'volunteering':
        ...
        html += `<div class="cv-section-executive">`
        html += `<h2 class="cv-section-title-executive">${sectionToUse.title || 'VOLONTÄRARBETE'}</h2>`
        html += `<div class="cv-section-content-executive">`
        data.sections.volunteering.forEach((vol: any) => {
          ...
          html += `<div class="cv-item-executive" data-keep>`
          html += `<div class="cv-item-header-executive">`
          if (volTitle) html += `<h3 class="cv-item-title-executive">${volTitle}</h3>`
          if (volDates) html += `<span class="cv-item-date-executive">${volDates}</span>`
          html += `</div>`
          if (volOrg || volLocation) {
            const orgLocation = [volOrg, volLocation].filter(v => v && v.trim() !== '').join(', ')
            html += `<p class="cv-item-subtitle-executive">${orgLocation}</p>`
          }
      ...
      case 'licenses':
        ...
        html += `<div class="cv-section-executive">`
        html += `<h2 class="cv-section-title-executive">${sectionToUse.title || 'LICENSER'}</h2>`
        html += `<div class="cv-section-content-executive">`
        data.sections.licenses.forEach((license: any) => {
          ...
          html += `<div class="cv-item-executive" data-keep>`
          html += `<div class="cv-item-header-executive">`
          if (licenseName) html += `<h3 class="cv-item-title-executive">${licenseName}</h3>`
          if (licenseDate) html += `<span class="cv-item-date-executive">${licenseDate}</span>`
          html += `</div>`
          if (licenseIssuer) html += `<p class="cv-item-subtitle-executive">${licenseIssuer}</p>`
          html += `</div>`
        })
        html += `</div></div>`
        break
      ...
      case 'custom':
        ...
        html += `<div class="cv-section-executive">`
        html += `<h2 class="cv-section-title-executive">${sectionToUse.title || 'ÖVRIGT'}</h2>`
        html += `<div class="cv-section-content-executive">`
        data.sections.custom.forEach((entry: any) => {
          ...
          html += `<div class="cv-item-executive" data-keep>`
          if (entryTitle) html += `<h3 class="cv-item-title-executive">${entryTitle}</h3>`
