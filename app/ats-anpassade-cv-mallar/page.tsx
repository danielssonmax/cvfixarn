...
export const metadata = {
  ...
  description: "Förbättra ditt jobbsökande med våra ATS-anpassade cv-mallar. Imponera på mänskliga och robotrekryterare med en effektiv design. Överlista algoritmen och visa att du är noga med detaljer.",
}
