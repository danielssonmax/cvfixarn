      ...
      <div className="mb-3 flex items-start gap-3">
        ...
        <div className="flex-1 -ml-1">
            ...
            >
              <div className="flex flex-col gap-1 flex-grow">
                <span className="text-gray-900 text-sm font-medium">
                  {field.name || "Ny kompetens"}
                </span>
                {field.level && (
                  <p className="text-gray-500 text-xs">{field.level}</p>
                )}
              </div>
          ...
          {isOpen && (
            ...
            >
              <div>
                <Label className="block mb-2 text-sm font-normal text-gray-700">Kompetens</Label>
                <Input
              ...
              <div className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col gap-1">
                    <span className="text-gray-900 text-sm font-medium">
                      {activeField.name || "Ny kompetens"}
                    </span>
                    {activeField.level && (
                      <p className="text-gray-500 text-xs">{activeField.level}</p>
                    )}
                  </div>
                </div>
              </div>
