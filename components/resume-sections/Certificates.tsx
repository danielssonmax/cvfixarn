    ...
    <div ref={setNodeRef} style={style} className={isDragging ? 'opacity-50' : ''}>
      <div className="mb-3 flex items-start gap-3">
        ...
        {isOpen && (
          ...
          >
              <div>
                <Label className="block mb-2 text-sm font-normal text-gray-700">Certifikatnamn</Label>
                <Input
              ...
              <div>
                ...
                <Input
                  {...register(`sections.certificates.${index}.issuer`)}
                  className="!border-2 !border-transparent bg-gray-100 hover:bg-gray-200 focus:bg-white focus:!border-[#00bf63] focus:ring-0 focus-visible:ring-0 focus:outline-none focus-visible:outline-none h-11 text-sm rounded-md transition-colors"
                  placeholder=""
                />
              </div>
              ...
              <div>
                ...
                <Input
                  {...register(`sections.certificates.${index}.date`)}
                  className="!border-2 !border-transparent bg-gray-100 hover:bg-gray-200 focus:bg-white focus:!border-[#00bf63] focus:ring-0 focus-visible:ring-0 focus:outline-none focus-visible:outline-none h-11 text-sm rounded-md transition-colors"
                  placeholder=""
                />
              </div>
              ...
              <div>
                ...
                <Input
                  {...register(`sections.certificates.${index}.url`)}
                  className="!border-2 !border-transparent bg-gray-100 hover:bg-gray-200 focus:bg-white focus:!border-[#00bf63] focus:ring-0 focus-visible:ring-0 focus:outline-none focus-visible:outline-none h-11 text-sm rounded-md transition-colors"
                  placeholder=""
                />
              </div>
...
export const Certificates: React.FC = () => {
  ...
  const watchFieldArray = watch("sections.certificates") || []
                ...
                <div className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col gap-1">
                      <span className="text-gray-900 text-sm font-medium">
                        {activeField.name || "Nytt certifikat"}
                      </span>
                      {activeField.issuer && (
