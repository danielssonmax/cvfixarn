...
function SortableVolunteeringItem({ 
  field, 
  index, 
  isOpen, 
  onToggle,
      ...
      <div className="mb-3 flex items-start gap-3">
        ...
        <div className="flex-1 -ml-1">
          ...
          {isOpen && (
            ...
            >
              <div>
                <Label className="block mb-2 text-sm font-normal text-gray-700">Roll</Label>
                <Input
                  {...register(`sections.volunteering.${index}.title`)}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label className="block mb-2 text-sm font-normal text-gray-700">Organisation</Label>
                  <Input
                    {...register(`sections.volunteering.${index}.company`)}
                    className="!border-2 !border-transparent bg-gray-100 hover:bg-gray-200 focus:bg-white focus:!border-[#00bf63] focus:ring-0 focus-visible:ring-0 focus:outline-none focus-visible:outline-none h-11 text-sm rounded-md transition-colors"
                    placeholder=""
                  />
                </div>
                <div>
                  ...
                  <Input
                    {...register(`sections.volunteering.${index}.location`)}
                    className="!border-2 !border-transparent bg-gray-100 hover:bg-gray-200 focus:bg-white focus:!border-[#00bf63] focus:ring-0 focus-visible:ring-0 focus:outline-none focus-visible:outline-none h-11 text-sm rounded-md transition-colors"
                    placeholder=""
                  />
                </div>
              ...
              <div className="grid grid-cols-[1fr_1fr_auto] gap-4 items-end">
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <select
                      {...register(`sections.volunteering.${index}.startDate`)}
                    ...
                    <select
                      {...register(`sections.volunteering.${index}.startYear`)}
                      className="!border-2 !border-transparent bg-gray-100 hover:bg-gray-200 focus:bg-white focus:!border-[#00bf63] focus:ring-0 focus-visible:ring-0 focus:outline-none focus-visible:outline-none h-11 text-sm rounded-md transition-colors px-3 py-2 w-full"
                    >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <select
                      {...register(`sections.volunteering.${index}.endDate`)}
                    ...
                    <select
                      {...register(`sections.volunteering.${index}.endYear`)}
                      className="!border-2 !border-transparent bg-gray-100 hover:bg-gray-200 focus:bg-white focus:!border-[#00bf63] focus:ring-0 focus-visible:ring-0 focus:outline-none focus-visible:outline-none h-11 text-sm rounded-md transition-colors px-3 py-2 w-full disabled:opacity-50 disabled:cursor-not-allowed"
                      disabled={field.current}
                    >
                      <option value="">År</option>
                ...
                <div className="flex items-center gap-2 mb-1">
                  <Switch
                    ...
                    onCheckedChange={(checked) => {
                      setValue(`sections.volunteering.${index}.current`, checked)
                      if (checked) {
                        setValue(`sections.volunteering.${index}.endDate`, "")
                        setValue(`sections.volunteering.${index}.endYear`, "")
                      }
                    }}
                  />
                  <Label className="text-sm font-normal text-gray-700 cursor-pointer" onClick={() => {
                    const current = field.current
                    setValue(`sections.volunteering.${index}.current`, !current)
                    if (!current) {
                      setValue(`sections.volunteering.${index}.endDate`, "")
                      setValue(`sections.volunteering.${index}.endYear`, "")
                    }
              ...
              <div>
                ...
                <RichTextEditor
                  name={`sections.volunteering.${index}.description`}
                  control={control}
...
export const Volunteering: React.FC = () => {
  ...
  const watchFieldArray = watch("sections.volunteering") || []
                ...
                <div className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col gap-1">
                      <span className="text-gray-900 text-sm font-medium">
                        {activeField.title || "Nytt uppdrag"}
                      </span>
