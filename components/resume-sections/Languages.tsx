...
import { Trash2, Plus, ChevronDown, MoreVertical, Check, GripVertical } from "lucide-react"
      ...
      <div className="mb-3 flex items-start gap-3">
        ...
        <div className="flex-1 -ml-1">
            ...
            >
              <div className="flex flex-col gap-1 flex-grow">
                <span className="text-gray-900 text-sm font-medium">
                  {field.name || "Nytt språk"}
                </span>
                {field.proficiency && (
                  <p className="text-gray-500 text-xs">{field.proficiency}</p>
                )}
              </div>
          ...
          {isOpen && (
            ...
            >
              <div>
                <Label className="block mb-2 text-sm font-normal text-gray-700">Språk</Label>
                <Input
              ...
              <div>
                <Label className="block mb-2 text-sm font-normal text-gray-700">Nivå</Label>
                <select
              ...
              <div className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col gap-1">
                    <span className="text-gray-900 text-sm font-medium">
                      {activeField.name || "Nytt språk"}
                    </span>
                    {activeField.proficiency && (
                      <p className="text-gray-500 text-xs">{activeField.proficiency}</p>
                    )}
                  </div>
                </div>
              </div>
