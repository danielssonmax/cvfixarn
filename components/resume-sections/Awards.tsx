        ...
        {isOpen && (
          ...
          >
              <div>
                ...
                <Input
                  {...register(`sections.awards.${index}.title`)}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    {...register(`sections.awards.${index}.issuer`)}
                    className="!border-2 !border-transparent bg-gray-100 hover:bg-gray-200 focus:bg-white focus:!border-[#00bf63] focus:ring-0 focus-visible:ring-0 focus:outline-none focus-visible:outline-none h-11 text-sm rounded-md transition-colors"
                    placeholder=""
                  />
                </div>
                <div>
                  <Label className="block mb-2 text-sm font-normal text-gray-700">År</Label>
                  <Input
                    {...register(`sections.awards.${index}.date`)}
                    className="!border-2 !border-transparent bg-gray-100 hover:bg-gray-200 focus:bg-white focus:!border-[#00bf63] focus:ring-0 focus-visible:ring-0 focus:outline-none focus-visible:outline-none h-11 text-sm rounded-md transition-colors"
                    placeholder=""
                  />
                </div>
              ...
              <div>
                ...
                <RichTextEditor
                  name={`sections.awards.${index}.description`}
                  control={control}
...
export const Awards: React.FC = () => {
  ...
  const watchFieldArray = watch("sections.awards") || []
                ...
                <div className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col gap-1">
                      <span className="text-gray-900 text-sm font-medium">
                        {activeField.title || "Ny utmärkelse"}
                      </span>
                    </div>
                  </div>
                </div>
