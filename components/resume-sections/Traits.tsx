      ...
      <div className="mb-3 flex items-start gap-3">
        ...
        <div className="flex-1 -ml-1">
          ...
          {isOpen && (
            ...
            >
              <div>
                <Label className="block mb-2 text-sm font-normal text-gray-700">Egenskap</Label>
                <Input
                  {...register(`sections.traits.${index}.name`)}
