    ...
    <div ref={setNodeRef} style={style} className={isDragging ? 'opacity-50' : ''}>
      <div className="mb-3 flex items-start gap-3">
            ...
            >
              <div className="flex flex-col gap-1 flex-grow">
                <span className="text-gray-900 text-sm font-medium">
                  {field.name || "Ny licens"}
                </span>
                {field.issuer && (
                  <p className="text-gray-500 text-xs">{field.issuer}</p>
                )}
              </div>
        ...
        {isOpen && (
          ...
          >
              <div>
                <Label className="block mb-2 text-sm font-normal text-gray-700">Licensnamn</Label>
                <Input
                  {...register(`sections.licenses.${index}.name`)}
              ...
              <div>
                <Label className="block mb-2 text-sm font-normal text-gray-700">Utfärdare</Label>
                <Input
                  {...register(`sections.licenses.${index}.issuer`)}
                  className="!border-2 !border-transparent bg-gray-100 hover:bg-gray-200 focus:bg-white focus:!border-[#00bf63] focus:ring-0 focus-visible:ring-0 focus:outline-none focus-visible:outline-none h-11 text-sm rounded-md transition-colors"
                  placeholder=""
                />
              </div>
              ...
              <div>
                ...
                <Input
                  {...register(`sections.licenses.${index}.date`)}
                  className="!border-2 !border-transparent bg-gray-100 hover:bg-gray-200 focus:bg-white focus:!border-[#00bf63] focus:ring-0 focus-visible:ring-0 focus:outline-none focus-visible:outline-none h-11 text-sm rounded-md transition-colors"
                  placeholder=""
                />
              </div>
              ...
              <div>
                <Label className="block mb-2 text-sm font-normal text-gray-700">URL (valfritt)</Label>
                <Input
                  {...register(`sections.licenses.${index}.url`)}
                  className="!border-2 !border-transparent bg-gray-100 hover:bg-gray-200 focus:bg-white focus:!border-[#00bf63] focus:ring-0 focus-visible:ring-0 focus:outline-none focus-visible:outline-none h-11 text-sm rounded-md transition-colors"
                  placeholder=""
                />
              </div>
...
export const Licenses: React.FC = () => {
  ...
  const watchFieldArray = watch("sections.licenses") || []
